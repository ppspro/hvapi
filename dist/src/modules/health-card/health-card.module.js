...
exports.HealthCardModule = void 0;
const common_1 = require("@nestjs/common");
const health_card_controller_1 = require("./presentation/controllers/health-card.controller");
    ...
    (0, common_1.Module)({
        ...
        providers: [
            health_card_service_1.HealthCardService,
            {
                ...
                useClass: health_card_repository_1.HealthCardRepository,
            },
        ],
        exports: [health_card_service_1.HealthCardService],
    })
], HealthCardModule);
//# sourceMappingURL=health-card.module.js.map
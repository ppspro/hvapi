import { DoctorProfileEntity, DoctorQualificationEntity, DoctorCertificationEntity, DoctorExperienceEntity, DoctorDocumentEntity, DoctorScheduleSlotEntity, DoctorHistoryEntity, DoctorAuditLogEntity } from '../entities/doctor.entity';

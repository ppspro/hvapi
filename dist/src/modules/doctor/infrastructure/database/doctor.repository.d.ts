...
import { DoctorProfileEntity, DoctorQualificationEntity, DoctorCertificationEntity, DoctorExperienceEntity, DoctorDocumentEntity, DoctorScheduleSlotEntity, DoctorHistoryEntity, DoctorAuditLogEntity } from '../../domain/entities/doctor.entity';

export declare class InsuranceProviderEntity {
    id: string;
    name: string;
    code: string;
...
export declare class InsurancePlanEntity {
    id: string;
    providerId: string;
    name: string;
    planCode: string;
...
export declare class InsuranceBeneficiaryEntity {
    id: string;
    policyId: string;
    fullName: string;
    relationship: string;
...
export declare class InsuranceClaimDraftEntity {
    id: string;
    policyId: string;
    patientProfileId: string;
    claimNumber: string;
...
export declare class InsuranceHistoryEntity {
    id: string;
    policyId: string;
    action: string;
...
export declare class InsuranceAuditLogEntity {
    id: string;
    policyId: string;
    action: string;
    performedBy?: string | null;

...
import { VaccineEntity, VaccinationScheduleEntity, VaccinationRecordEntity, VaccinationCertificateEntity, VaccinationReminderConfigEntity, VaccinationHistoryEntity, VaccinationAuditLogEntity } from '../../domain/entities/immunisation.entity';
export declare class ImmunisationRepository implements IImmunisationRepository {
    private readonly db;

...
describe('FamilyService', () => {
    ...
    describe('resendInvitation', () => {
        it('should throw if invitation not found', async () => {
            ...
            await expect(service.resendInvitation(mockUserId, mockInvitationId)).rejects.toThrow(common_1.NotFoundException);
        });
        it('should throw if invitation not owned by patient', async () => {
            ...
            await expect(service.resendInvitation(mockUserId, mockInvitationId)).rejects.toThrow(common_1.ForbiddenException);
        });
        it('should throw if max resend count reached', async () => {
            ...
            await expect(service.resendInvitation(mockUserId, mockInvitationId)).rejects.toThrow(common_1.BadRequestException);
        });
    });
    ...
    describe('revokeConsent', () => {
        it('should throw if consent already revoked', async () => {
            ...
            await expect(service.revokeConsent(mockUserId, mockConsentId)).rejects.toThrow(common_1.BadRequestException);
        });
    ...
    describe('createGuardian', () => {
        it('should create guardian with isGuardian flag set to true', async () => {
            ...
            const result = await service.createGuardian(mockUserId, {
                ...
                relationshipType: 'GUARDIAN', relationship: 'Father',
            });
    ...
    describe('createDependent', () => {
        it('should create dependent with isDependent flag set to true', async () => {
            ...
            const result = await service.createDependent(mockUserId, {
                ...
                relationshipType: 'CHILD', relationship: 'Daughter',
            });

import { AdminDashboardSummaryEntity, PermissionGroupEntity, PermissionEntity, OrganizationEntity, PlatformSettingEntity, ManagedUserEntity } from '../entities/admin.entity';

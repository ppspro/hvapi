...
import { PatientReferralEntity, ReferralNoteEntity, ReferralAttachmentEntity, ReferralStatusHistoryEntity } from '../../domain/entities/referral.entity';
export declare class PrismaReferralRepository implements IReferralRepository {
    private readonly db;

...
const auth_repository_1 = require("./infrastructure/database/auth.repository");
const jwt_strategy_1 = require("./infrastructure/validators/jwt.strategy");
        ...
        imports: [
            ...
            jwt_1.JwtModule.registerAsync({
                ...
                useFactory: (configService) => ({
                    secret: configService.get('JWT_SECRET') || 'hvapi_default_secret_key',
                    signOptions: {

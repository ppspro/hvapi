...
import { OCRJobEntity, OCRPageEntity, ExtractedFieldEntity, OCRTemplateEntity, OCRVerificationEntity, OCRAuditLogEntity } from '../../domain/entities/ocr.entity';
export declare class PrismaOcrRepository implements IOcrRepository {
    private readonly db;

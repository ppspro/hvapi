...
import { SystemMetricEntity, ApplicationLogEntity, TraceExecutionEntity, BackgroundJobEntity, SystemHealthCheckEntity, PerformanceSnapshotEntity } from '../../domain/entities/observability.entity';
export declare class PrismaObservabilityRepository implements IObservabilityRepository {
    private readonly db;

import { SecurityConsentRecordEntity, EncryptionKeyEntity, RetentionPolicyEntity, SecurityIncidentEntity, SecurityPlatformAuditLogEntity, ComplianceReportEntity } from '../entities/security.entity';

...
export declare class RecurringScheduleEntity {
    id: string;
    scheduleId: string;
...
export declare class ScheduleExceptionEntity {
    id: string;
    scheduleId: string;
...
export declare class LeaveBlockEntity {
    id: string;
    scheduleId: string;
    leaveType: string;
    startDate: Date;
...
export declare class HolidayCalendarEntity {
    id: string;
    facilityId?: string | null;
    name: string;
    holidayDate: Date;
...
export declare class GeneratedSlotEntity {
    id: string;
    scheduleId: string;
    slotDate: Date;
    startTime: string;
...
export declare class ScheduleAuditLogEntity {
    id: string;
    scheduleId: string;
    action: string;

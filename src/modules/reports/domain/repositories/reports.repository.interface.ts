...
export interface IReportsRepository {
  ...
  reorderWidgets(widgetOrders: { id: string; displayOrder: number }[]): Promise<void>;
  ...
  // Audit
  createAuditLog(data: { reportId?: string; action: string; performedBy?: string; details?: string }): Promise<ReportAuditLogEntity>;

...
export interface IReportRepository {
  ...
  findReportsByProfileId(profileId: string): Promise<(MedicalReportEntity & { attachments: ReportAttachmentEntity[] })[]>;
  findReportById(reportId: string): Promise<(MedicalReportEntity & { attachments: ReportAttachmentEntity[] }) | null>;

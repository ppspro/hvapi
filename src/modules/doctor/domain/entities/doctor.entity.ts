...
export class DoctorQualificationEntity {
  id!: string;
...
export class DoctorCertificationEntity {
  id!: string;
  doctorProfileId!: string;
  title!: string;
...
export class DoctorExperienceEntity {
  id!: string;
  doctorProfileId!: string;
  designation!: string;
  hospitalName!: string;
...
export class DoctorDocumentEntity {
  id!: string;
  doctorProfileId!: string;
  documentType!: string;
...
export class DoctorHistoryEntity {
  id!: string;
  doctorProfileId!: string;
  action!: string;

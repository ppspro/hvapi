...
} from '../entities/health-card.entity';

export interface IHealthCardRepository {
  findProfileByUserId(userId: string): Promise<{ id: string; firstName?: string | null; lastName?: string | null; dateOfBirth?: Date | null; bloodGroup?: string | null } | null>;

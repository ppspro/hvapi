...
export class FacilityBranchEntity {
  id!: string;
  facilityId!: string;
  branchName!: string;
...
export class FacilityRoomEntity {
  id!: string;
  facilityId!: string;
...
export class FacilityLicenseEntity {
  id!: string;
  facilityId!: string;
  licenseType!: string;
...
export class FacilityAccreditationEntity {
  id!: string;
  facilityId!: string;
...
export class FacilityDocumentEntity {
  id!: string;
  facilityId!: string;
  documentType!: string;
...
export class DoctorFacilityEntity {
  id!: string;
  doctorId!: string;
  facilityId!: string;
  departmentId?: string | null;
...
export class FacilityHistoryEntity {
  id!: string;
  facilityId!: string;
  action!: string;
...
export class FacilityAuditLogEntity {
  id!: string;
  facilityId!: string;
  action!: string;
  performedBy?: string | null;
